...
public class SourceData {
    ...
    private RustyProgramElement element;
    ...
    public SourceData(RustyProgramElement element, int childPos, Services services) {
    ...
    public RustyProgramElement getElement() {
        return element;
    }
    ...
    public void setElement(RustyProgramElement element) {
        this.element = element;
    }
    ...
    public RustyProgramElement getSource() {
        ...
        if (childPos < element.getChildCount()) {
            return (RustyProgramElement) element.getChild(childPos);
        } else {
            return null;
        }
    }
