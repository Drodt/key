...
public class AntecSuccPrefixChecker implements Checker {
    ...
    public static final AntecSuccPrefixChecker ANTE_POLARITY_CHECKER =
        new AntecSuccPrefixChecker(AntecSuccPrefixChecker.Polarity.ANTECEDENT);
    ...
    public static final AntecSuccPrefixChecker SUCC_POLARITY_CHECKER =
        new AntecSuccPrefixChecker(AntecSuccPrefixChecker.Polarity.SUCCEDENT);
    ...
    public boolean check(PosInOccurrence pio) {
        ...
        return (polarity != AntecSuccPrefixChecker.Polarity.ANTECEDENT || pol == -1)
                && (polarity != AntecSuccPrefixChecker.Polarity.SUCCEDENT || pol == 1);
    }
}
