...
import org.key_project.rusty.strategy.definition.AbstractStrategyPropertyDefinition;
...
public class ModularRustyDLStrategyFactory implements StrategyFactory {
    private final List<StrategyFactory> componentFactories = Arrays.asList(new FOLStrategyFactory(),
        ...
        new RustyDLStrategyFactory());

    /// The unique [Name] of this [StrategyFactory].
    public static final Name NAME = ModularRustyDLStrategy.NAME;
    ...
    public ModularRustyDLStrategyFactory() {
    }
