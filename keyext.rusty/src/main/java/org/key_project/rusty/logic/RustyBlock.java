...
@Override public boolean equals(Object o){if(o==this)return true;if(!(o instanceof RustyBlock(RustyProgramElement program1)))return false;if(program1==null)return program()==null;return program1.equals(program());}

/** returns the hashCode */
@Override public int hashCode(){return 17+((program()==null)?0:program().hashCode());}}
