 ...
 */
public TacletPrefix setContext(boolean setTo){return new TacletPrefix(prefixLength,setTo);}
...
public boolean equals(Object o){if(o==this){return true;}if(!(o instanceof TacletPrefix(int length,boolean context1))){return false;}return(length==prefixLength())&&(context1==context());}

public int hashCode(){int result=17;result=37*result+prefixLength();result=37*result+(context()?0:1);return result;}

public String toString(){return"TacletPrefix: "+prefixLength()+(context()?"+ { K }":"");}}
