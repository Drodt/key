 ...
 * {@link TacletMatchProgram#match(Term, MatchResultInfo, LogicServices)}.
 */
public class TacletMatchProgram {
     ...
     * @param p_matchCond the initial {@link MatchResultInfo} which have to be satisfied in addition
     ...
     */
    public MatchResultInfo match(Term p_toMatch, MatchResultInfo p_matchCond,
