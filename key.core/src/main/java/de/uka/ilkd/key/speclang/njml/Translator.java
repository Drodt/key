...
class Translator extends JmlParserBaseVisitor<Object> {
    ...
    public SLExpression visitInstance_of(JmlParser.Instance_ofContext ctx) {
        ...
        assert rtype != null;
        final SortDependingFunction f = services.getJavaDLTheory().getInstanceofSymbol(rtype.getSort(), services);
    ...
    public Object visitSt_expr(JmlParser.St_exprContext ctx) {
        ...
        if (result.getTerm() == null) {
            ...
            final Function ioFunc = services.getJavaDLTheory().getInstanceofSymbol(right.getType().getSort(), services);
