 ...
 * checks of applied operation contracts.
 */
public class FormulaTermLabel implements TermLabel {
    ...
    /**
     * The prefix of the name used in {@link Services#getCounter(String)} to keep track of the
     * already used sub IDs.
     */
    ...
    private static String[] getBeforeIds(String beforeIds) {
        return beforeIds != null ? beforeIds.split(BEFORE_ID_SEPARATOR) : new String[0];
    }
